      ...
      children: [
        Column(
          ...
          children: [
            ...
            Text(name+" \n(For grabs)",style: productNameTextStyle,textAlign: TextAlign.left),
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children:const [
              Text("UGX 500,000,000",style: productCostTextStyle),
              Text("UGX 600,000,000",style: crossedProductCostTextStyle),
            ],)
          ],
        )
      ],
